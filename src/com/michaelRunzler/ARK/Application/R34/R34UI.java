...
import system.ARKTransThreadTransport.TransportType;
...
public class R34UI extends ARKApplication
{
    ...
    public void launch() throws Exception
    {
        ...
        window.getIcons().add(new Image("assets/r34-main.png"));
    ...
    private void sysInit()
    {
        ...
        editRule.setOnAction(e -> {
            ...
            if(index >= 0){
                ...
                // Get the edited rule from the Rule Manager once it finishes and closes.
                Rule tmp = ruleManager.getCurrentRule();

                // Check to see if the user cancelled. If they didn't, and the rule is valid, pass it to the Rule List.
                if(tmp != null) {
    ...
    /**
     * Retrieves images from the Rule 34 Paheal network.
    ...
    /**
     * Retrieves images from the original Rule 34 network.
     * @param tag the tag to search
     * @return the list of new image IDs in the master index
     * @throws ARKTransThreadTransport if a problem is encountered during operation
     */
