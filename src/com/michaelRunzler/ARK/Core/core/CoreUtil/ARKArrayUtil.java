...
public class ARKArrayUtil
{
     ...
     * to the default spacing (in this case, {@code 8}). Non-integral subclasses of {@link Number} (for example, {@link Float}
     * will have their non-integral components removed with no rounding (effectively rounded down for most types).
     ...
     */
    public static byte[] toBinaryArray(Number value){
        return toBinaryArray(value, 8);
    }
