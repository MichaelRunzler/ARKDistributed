...
/**
 * Superclass for all com.michaelRunzler.ARK application platform programs. Allows subclasses to be
 * started and managed from the com.michaelRunzler.ARK launcher.
 */
